...
--
-- Host: localhost    Database: springboot02xk1
-- ------------------------------------------------------
...
--
-- Current Database: `springboot02xk1`
--

/*!40000 DROP DATABASE IF EXISTS `springboot02xk1`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `springboot02xk1` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
INSERT INTO `token` VALUES (1,21,'经理账号1','xiangmujingli','项目经理','ccl1l3hz5p6iat6qbcqg3l8af25s251h','2023-05-11 12:01:03','2023-05-11 13:01:03');
...
CREATE TABLE `xiangmujindu` (
  ...
  `tourushijian` int(11) DEFAULT NULL COMMENT '投入时间',
  `chengbenjine` float DEFAULT NULL COMMENT '成本金额',
  `shengyutianshu` varchar(200) DEFAULT NULL COMMENT '剩余天数',
...
INSERT INTO `xiangmujindu` VALUES (61,'2023-05-11 11:59:31','项目名称1','项目分类1','进行中',1,1,'剩余天数1','预期目标1','进展情况1','账号1','姓名1','经理账号1','经理姓名1'),(62,'2023-05-11 11:59:31','项目名称2','项目分类2','进行中',2,2,'剩余天数2','预期目标2','进展情况2','账号2','姓名2','经理账号2','经理姓名2'),(63,'2023-05-11 11:59:31','项目名称3','项目分类3','进行中',3,3,'剩余天数3','预期目标3','进展情况3','账号3','姓名3','经理账号3','经理姓名3'),(64,'2023-05-11 11:59:31','项目名称4','项目分类4','进行中',4,4,'剩余天数4','预期目标4','进展情况4','账号4','姓名4','经理账号4','经理姓名4'),(65,'2023-05-11 11:59:31','项目名称5','项目分类5','进行中',5,5,'剩余天数5','预期目标5','进展情况5','账号5','姓名5','经理账号5','经理姓名5'),(66,'2023-05-11 11:59:31','项目名称6','项目分类6','进行中',6,6,'剩余天数6','预期目标6','进展情况6','账号6','姓名6','经理账号6','经理姓名6'),(67,'2023-05-11 11:59:31','项目名称7','项目分类7','进行中',7,7,'剩余天数7','预期目标7','进展情况7','账号7','姓名7','经理账号7','经理姓名7'),(68,'2023-05-11 11:59:31','项目名称8','项目分类8','进行中',8,8,'剩余天数8','预期目标8','进展情况8','账号8','姓名8','经理账号8','经理姓名8');
...
-- Dump completed on 2023-05-12 21:02:08
