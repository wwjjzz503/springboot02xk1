	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","width":"100%","alignItems":"center","background":"url(http://codegen.caihongy.cn/20220722/898b4b26c0464f8caa1cd58e5eafe0c9.png) no-repeat center top / 100% 100%","justifyContent":"center","display":"flex"}'>
			<el-form v-if="pageFlag=='register'" :style='{"border":" 8px solid #FFFFFF","padding":"10px 20px","margin":"0","borderRadius":"0 0 50px 50px","top":"0","background":"rgba(228, 239, 254, 0.8000)","width":"450px","position":"absolute","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"padding":"10px 20px","margin":"0 0 10px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"24px","height":"auto"}' class="title">基于B/S架构的企业项目管理系统的设计与实现注册</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='xiangmujingli'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">经理账号</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='xiangmujingli'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">经理姓名</div>
		...
		login() {
            ...
            if(this.ruleForm.touxiang!=null) {
                this.ruleForm.touxiang = this.ruleForm.touxiang.replace(new RegExp(this.$base.url,"g"),"");
					...
					if((!this.ruleForm.jinglizhanghao) && `xiangmujingli` == this.tableName){
					...
					if((!this.ruleForm.jinglixingming) && `xiangmujingli` == this.tableName){
