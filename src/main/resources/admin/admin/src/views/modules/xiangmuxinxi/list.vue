<template>
  <div class="main-content" :style="{ padding: '30px' }">
    ...
    <template v-if="showFlag">
      ...
      >
        <el-row :style="{ display: 'block' }">
          ...
          <div
            :style="{ margin: '0 30px 0 0', display: 'inline-block' }"
            class="select"
            label="项目分类"
            prop="xiangmufenlei"
          >
            ...
            >
            <el-select
              @change="xiangmufenleiChange"
              clearable
              v-model="searchForm.xiangmufenlei"
              placeholder="请选择项目分类"
            >
              <el-option
        ...
        <el-table-column width="300" label="操作">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              v-if="isAuth('xiangmuxinxi', '分配')"
              type="success"
              size="mini"
              @click="
                xiangmufenpeiCrossAddOrUpdateHandler(
                  scope.row,
                  'cross',
                  '',
                  '',
    ...
    <xiangmufenpei-cross-add-or-update
      v-if="xiangmufenpeiCrossAddOrUpdateFlag"
      :parent="this"
      ref="xiangmufenpeiCrossaddOrUpdate"
    ></xiangmufenpei-cross-add-or-update>
  </div>
</template>
  ...
  methods: {
    ...
    getDataList() {
      ...
      if (
        ...
        this.searchForm.xiangmufenlei != undefined
      ) {
