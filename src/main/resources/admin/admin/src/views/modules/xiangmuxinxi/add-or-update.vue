<template>
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="项目编号" prop="xiangmubianhao">
					<el-input v-model="ruleForm.xiangmubianhao" placeholder="项目编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.xiangmubianhao" label="项目编号" prop="xiangmubianhao">
					<el-input v-model="ruleForm.xiangmubianhao" placeholder="项目编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="项目名称" prop="xiangmumingcheng">
					<el-input v-model="ruleForm.xiangmumingcheng" placeholder="项目名称" clearable  :readonly="ro.xiangmumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="项目名称" prop="xiangmumingcheng">
					<el-input v-model="ruleForm.xiangmumingcheng" placeholder="项目名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="项目分类" prop="xiangmufenlei">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="项目分类" prop="xiangmufenlei">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'" label="经理账号" prop="jinglizhanghao">
					<el-select :disabled="ro.jinglizhanghao" @change="jinglizhanghaoChange" v-model="ruleForm.jinglizhanghao" placeholder="请选择经理账号">
						<el-option
							v-for="(item,index) in jinglizhanghaoOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jinglizhanghao" label="经理账号" prop="jinglizhanghao">
					<el-input v-model="ruleForm.jinglizhanghao" placeholder="经理账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="经理姓名" prop="jinglixingming">
					<el-input v-model="ruleForm.jinglixingming" placeholder="经理姓名" clearable  :readonly="ro.jinglixingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="经理姓名" prop="jinglixingming">
					<el-input v-model="ruleForm.jinglixingming" placeholder="经理姓名" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-if="type!='info'"  label="项目内容" prop="xiangmuneirong">
					<editor 
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.xiangmuneirong" label="项目内容" prop="xiangmuneirong">
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.$http({
				url: `option/xiangmujingli/jinglizhanghao`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
					this.jinglizhanghaoOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
			...
			// 下二随
			jinglizhanghaoChange () {
				this.$http({
					url: `follow/xiangmujingli/jinglizhanghao?columnValue=`+ this.ruleForm.jinglizhanghao,
					method: "get"
				}).then(({ data }) => {
					if (data && data.code === 0) {
						if(data.data.jinglixingming){
							this.ruleForm.jinglixingming = data.data.jinglixingming
						}
					} else {
						this.$message.error(data.msg);
					}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.xiangmuneirong = this.ruleForm.xiangmuneirong.replace(reg,'../../../springboot02xk1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
