    ...
    >
      <template>
        ...
        <el-form-item
          ...
          class="input"
          v-else-if="ruleForm.tixingshijian"
          label="提醒时间"
          prop="tixingshijian"
        >
          <el-input
      ...
      <el-form-item
        ...
        v-else-if="ruleForm.tixingneirong"
        label="提醒内容"
        prop="tixingneirong"
      >
        <span
    ...
    info(id) {
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.ruleForm.tixingneirong = this.ruleForm.tixingneirong.replace(
            reg,
      ...
      this.$refs["ruleForm"].validate((valid) => {
        if (valid) {
          if (crossrefid && crossuserid) {
                    ...
                    if (data && data.code === 0) {
                      this.$message({
                        ...
                        onClose: () => {
                          ...
                          this.parent.xiangmutixingCrossAddOrUpdateFlag = false;
                          this.parent.search();
            ...
            this.$http({
              url: `xiangmutixing/${!this.ruleForm.id ? "save" : "update"}`,
              method: "post",
              data: this.ruleForm,
            }).then(({ data }) => {
              if (data && data.code === 0) {
